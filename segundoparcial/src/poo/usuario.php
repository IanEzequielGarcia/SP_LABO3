...
class Usuario implements IUsuario
{
    ...
    public function AltaUsuario(Request $request, Response $response, array $args): Response 
	{
        ...
        $id_agregado = $miUsuario->InsertarUsuario($miUsuario, "./fotos/".$path, $extension);
    ...
    public function ModificarUsuario(Request $request, Response $response, array $args) : Response
	{
        ...
        {
            $archivos['foto'] -> moveTo(__DIR__ . "/../../public/fotos/". $decoded -> correo . "_" . $decoded -> id_decoded."_modificacion" . ".".$extension[0]);
